    ...
    return (
        <>
            <div className="text-center md:hidden">
                <button
                    className="text-white bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none block md:hidden"
                    type="button"
                ...
                >
                    <Image
                        src="/assets/images/icons/grid-outline.svg"
                        alt="Grid"
                        height={16}
                        width={16}
                    />
